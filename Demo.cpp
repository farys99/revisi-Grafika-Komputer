...
void Demo::Render() {
	...
	DrawColoredCube(1, 0, 2.3, 0, 10, 0.5, 1);
	DrawColoredCube(0, 0, 1.6, 0, 0.3, 2, 0.3);
	DrawColoredCube(0, 0, 0.5, 0, 2, 2.5, 3);
	DrawColoredCube(0, 0, 0.5, 3, 1, 1, 5);
	DrawColoredCube(2, 1, 0.5, 5, 0.5, 0.5, 2.5);
	DrawColoredPlane();
